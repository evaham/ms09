...
const CounterButton = () => {
	...
	return (
		<div className="relative flex w-full h-6">
			<p className="absolute flex items-center justify-center inset-0 text-sm">{count}</p>
			<button onClick={handleDecrement} className="flex items-center justify-center w-6 h-6 mr-auto rounded-full bg-gray-100">
