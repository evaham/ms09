    ...
    return (
            <div className="sticky top-0 flex w-full h-14 items-center bg-white z-50 shadow-sm">
                ...
                <div onClick={() => setIsModalOpen(!isModalOpen)} className="flex-1 flex items-center h-full" >
                    <span className="flex-1 mr-1 text-lg font-bold line-clamp-1">투게더 할인 마투게더 할인 마투게더 할인 마투게더 할인 마투게더 할인 마투게더 할인 마트</span>
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" className="fill-slate-700">
