...
const NavMenu = () => {
    ...
    return (
            <div className="sticky top-0 flex w-full h-12 items-center bg-white z-50 shadow-sm">
                ...
                <div onClick={() => setIsModalOpen(!isModalOpen)} className="flex items-center h-full mr-auto" >
                ...
                <Link href={"/order-search"} className="flex items-center justify-center w-12 h-full ml-auto fill-slate-500">
