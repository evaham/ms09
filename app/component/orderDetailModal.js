...
const OrderDetailModal = () => {  
    ...
    return (
        <div className="fixed inset-0 flex flex-col items-center justify-center p-2 pt-8 bg-slate-950/50 z-30">
            <div className="relative flex flex-col w-full h-10/12 p-4 rounded-2xl bg-white overflow-hidden">
                ...
                <button className="absolute top-3 right-3 fill-slate-600" onClick={() => setIsVisible(false)}>
