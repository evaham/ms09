  ...
  return (
    <html lang="ko">
      ...
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased bg-slate-50`} >
        <div className="sticky top-0 flex w-full h-14 items-center bg-white z-50 shadow">
          <Link href={"/"} className="flex items-center justify-center w-14 h-full fill-slate-700">
          ...
          <Link className="flex items-center justify-center flex-1 h-12 mx-2 rounded-full" href="/">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" height="36px" viewBox="0 -960 960 960" width="36px" className="fill-slate-700">
          ...
          <Link href={"/order-search"} className="flex items-center justify-center w-14 h-full ml-auto fill-slate-700">
            <svg xmlns="http://www.w3.org/2000/svg" height="36px" viewBox="0 -960 960 960" width="36px">
