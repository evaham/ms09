...
export default function RootLayout({ children }) {
  return (
    <html lang="ko" className="dark">
      ...
      >
        <div className="sticky top-0 flex w-full h-14 items-center bg-white dark:bg-slate-800 z-50">
          <Link href={"/"} className="flex items-center justify-center w-14 h-full bg-slate-500" >
          ...
          <Link className="flex items-center justify-center flex-1 h-12 mx-2 rounded-full" href="/">
            <span className="line-clamp-1">(주)투게더 할인할인할인할인할인할인할인할인할인할인할인 마트</span>
            <svg xmlns="http://www.w3.org/2000/svg" height="36px" viewBox="0 -960 960 960" width="36px" fill="#8f8f8f">
          ...
          <Link href={"/"} className="flex items-center justify-center w-14 h-full ml-auto bg-slate-500">
            <svg xmlns="http://www.w3.org/2000/svg" height="36px" viewBox="0 -960 960 960" width="36px" fill="#e8eaed">
        ...
        {children}
        {/* <div className="p-4">
          <div className="text-center">마지막</div>
        </div> */}
      </body>
    </html>
  );
