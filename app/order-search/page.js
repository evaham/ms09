            ...
            <div className="flex flex-col p-3">
                ...
                <div className="flex flex-col p-4 rounded-lg bg-white shadow">
                    <div className="">
                        ...
                        <input type="text" placeholder="이름" className="w-full p-2 border border-slate-300 rounded focus:outline-none focus:border-teal-500" />
                    </div>
                    <div className="mt-2">
                        ...
                        <div className="relative flex">
                            ...
                            <input
                                ...
                                className="flex-1 flex items-center p-2 pl-16 border border-slate-300 rounded focus:outline-none focus:border-teal-500"
                            />
                        </div>
                    </div>
                </div>

                <div onClick={() => setIsAgreeModalOpen(true)} className="ml-auto mt-2 underline text-sm text-slate-500 cursor-pointer">개인정보 수집·이용 확인하기</div>
